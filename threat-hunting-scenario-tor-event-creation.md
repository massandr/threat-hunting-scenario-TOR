...
6. Create a folder on your desktop called ```wtb-tor.txt``` and put a few fake (illicit) items in there
7. Delete the file.
...
DeviceFileEvents
| where FileName contains "wtb-tor.txt"
```

---

## Created By:
- **Author Name**: Andrey Massalskiy
- **Author Contact**: https://www.linkedin.com/in/massandr/
- **Date**: May 10, 2025
